...
const SOON = [
['batches','ব্যাচ ম্যানেজমেন্ট'],['stock','স্টক রেজিস্টার'],
['damages','ক্ষতি / নষ্ট'],['sales','বিক্রয় ও চালান'],
['customers','গ্রাহক তালিকা'],['reports','রিপোর্ট ও বিশ্লেষণ'],
['employees','জনবল তালিকা'],['recycle-bin','Recycle Bin'],
];
...
export default function App() {
  return (
    <Routes>
      ...
      {/* ===== সুপার অ্যাডমিন ===== */}
      <Route path="/superadmin/login" element={<SaAuthProvider><SaLogin /></SaAuthProvider>} />
      <Route path="/superadmin" element={<SaAuthProvider><SaProtected><SaLayout /></SaProtected></SaAuthProvider>}>
