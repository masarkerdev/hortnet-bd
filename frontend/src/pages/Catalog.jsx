...
export default function Catalog() {
  ...
  async function loadSeedlings(c, filterQuery) {
    ...
    try {
      const r = await fetch(`${API}/api/public/center/${c.slug}/seedlings`, {
        cache: "no-store",
      });
      const d = await r.json();
      setSeedlings(d.data || []);
    ...
    >
      ...
      >
        ...
        >
          ...
          <b>উন্নত মানের ফল, ফুল, বনজ, ঔষধি, মসলা ও শোভাবর্ধনকারী</b> গাছের চারা
          ও কলমের তথ্য এবং আপনার নিকটস্থ সেন্টারে এর প্রাপ্যতা সহজেই খুঁজে নিন।
        </p>
        {/* Tabs */}
        <div
          style={{
                        ...
                        <div style={{ textAlign: "center", marginRight: 24 }}>
                          <div
                            style={{
                              ...
                              fontWeight: 700,
                              color:
                                s.current_stock > 50 ? "#1a6b3a" : "#f59e0b",
                            }}
                          >
                            {toBn(s.current_stock)}
                          </div>
